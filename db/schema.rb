...
ActiveRecord::Schema.define(version: 2020_01_06_113851) do
  ...
  create_table "products", force: :cascade do |t|
    ...
    t.string "pros"
    t.string "cons"
    t.boolean "has_mold", default: false, null: false
  ...
  create_table "usage_side_effects", force: :cascade do |t|
    t.bigint "usage_id"
    t.bigint "side_effect_id"
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["side_effect_id"], name: "index_usage_side_effects_on_side_effect_id"
    t.index ["usage_id"], name: "index_usage_side_effects_on_usage_id"
  end
  ...
  create_table "usages", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.integer "safe_to_use_status", default: 0, null: false
    t.binary "sample"
    t.integer "sample_process_status", default: 0, null: false
    t.index ["product_id"], name: "index_usages_on_product_id"
  ...
  create_table "user_treatments", force: :cascade do |t|
    ...
    t.datetime "updated_at", precision: 6, null: false
    t.datetime "deleted_at"
    t.index ["treatment_id"], name: "index_user_treatments_on_treatment_id"
    t.index ["user_id"], name: "index_user_treatments_on_user_id"
  end
